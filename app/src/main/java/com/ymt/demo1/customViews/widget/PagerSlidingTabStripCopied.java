...
public class PagerSlidingTabStripCopied extends HorizontalScrollView {
    ...
    private int tabTextColor = getResources().getColor(R.color.material_blue_grey_800);
    ...
    public PagerSlidingTabStripCopied(Context context) {
        this(context, null);
    }

    public PagerSlidingTabStripCopied(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PagerSlidingTabStripCopied(Context context, AttributeSet attrs, int defStyle) {
