...
public class GuideTabStrip extends HorizontalScrollView {
    ...
    public GuideTabStrip(Context context) {
        this(context, null);
    }

    public GuideTabStrip(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public GuideTabStrip(Context context, AttributeSet attrs, int defStyle) {
