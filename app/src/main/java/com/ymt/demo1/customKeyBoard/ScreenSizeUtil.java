...
public class ScreenSizeUtil {
    public static ScreenSizeUtil screenSizeUtil;
    ...
    private ScreenSizeUtil(Context context, int screenHeight, int contentBarHeight) {
     ...
     */
    public static ScreenSizeUtil getInstance(Context context, int screenHeight, int contentBarHeight) {
        if (screenSizeUtil == null) {
            screenSizeUtil = new ScreenSizeUtil(context, screenHeight, contentBarHeight);
        }
