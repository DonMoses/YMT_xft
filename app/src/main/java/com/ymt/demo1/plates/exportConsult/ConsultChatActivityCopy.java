 ...
 */
public class ConsultChatActivityCopy extends BaseActivity {
...
//        Log.e("TAG",">>>>>>>>>>>qq_id>>>>>>>>>>"+qq_id);
    ...
    protected void initTitle() {
        ...
        if (title.getChildCount() == 3) {
            title.getChildAt(2).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    //todo 跳转到预约界面
                    Toast.makeText(ConsultChatActivityCopy.this, "关注...", Toast.LENGTH_SHORT).show(); //打开预约界面
        ...
        title.setOnLeftActionClickListener(new MyTitle.OnLeftActionClickListener() {
            @Override
            public void onClick() {
                startActivity(new Intent(ConsultChatActivityCopy.this, MyConsultActivity.class));
                finish();
            }
        });
...
//                            Log.e("TAG", ">>>>>>>>>>>>>>>update>>>>>>>>>" + qqMsg.getMsg_id());
                    ...
                    清空未读记录
                     */
                    SharedPreferences sharedPreferences = ConsultChatActivityCopy.this.getSharedPreferences("unread_info", MODE_PRIVATE);
        ...
        return new StringRequest(BaseURLUtil.followExpert(sId, expertId), new Response.Listener<String>() {
            ...
            public void onResponse(String s) {
                try {
                    JSONObject jsonObject = new JSONObject(s);
                    if (jsonObject.getString("result").equals("Y")) {
                        Toast.makeText(ConsultChatActivityCopy.this, "已关注！", Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
    ...
    public static class MyHandler extends Handler {
        private WeakReference<ConsultChatActivityCopy> reference;

        public MyHandler(ConsultChatActivityCopy activity) {
        ...
        public void handleMessage(Message msg) {
            ...
            ConsultChatActivityCopy activity = reference.get();
...
//                            Log.e("TAG", ">>>>>>>>>>>>>>>update>>>>>>>>>" + qqMsg.getMsg_id());
    ...
    public static class ChatMsgRefreshThread extends Thread {
        ...
        public ChatMsgRefreshThread(ConsultChatActivityCopy activity) {
            reference = new WeakReference<>(activity);
            stopKey = false;
        }
        ...
        private void doRefresh(ConsultChatActivityCopy.MyHandler myHandler) {
