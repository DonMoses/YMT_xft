 ...
 */
public class EasyWrongActivity extends BaseFloatActivity {
    ...
    protected void initTitle() {
        ...
        title.setOnLeftActionClickListener(new MyTitle.OnLeftActionClickListener() {
            ...
            public void onClick() {
                ...
                if (curFragment instanceof EasyWrongContentFragment) {
                    initView();
                } else if (curFragment instanceof EasyWrongTypeListFragment) {
                    finish();
                }
            }
        });
    ...
    private void initView() {
        ...
        if (manager.findFragmentById(R.id.content) != null) {
            ...
            ft.replace(R.id.content, EasyWrongTypeListFragment.getInstance());
        } else {
            ft.add(R.id.content, EasyWrongTypeListFragment.getInstance());
        }
        ft.commit();
    }
    ...
    public void setTitleType(String type) {
        ...
        switch (type) {
            ...
            case "2":
                ...
                break;
            case "3":
                tStr = "初级建(构)筑物消防员-易错题";
                break;
            case "4":
                tStr = "中级建(构)筑物消防员-易错题";
                break;
            default:
                break;
        }
